...
import { PetstoreSDKStainlessTest, ClientOptions } from 'petstore-sdk-stainless-test';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: PetstoreSDKStainlessTest)`
    : `const run: (${functionSource.client}: PetstoreSDKStainlessTest) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
