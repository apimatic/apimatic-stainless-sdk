import fs from 'fs';
import type { ResponseLike } from 'petstore-sdk-stainless-test/internal/to-file';
import { toFile } from 'petstore-sdk-stainless-test/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('petstore-sdk-stainless-test/core/uploads');
    await expect(
