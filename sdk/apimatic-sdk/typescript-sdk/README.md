...
# Getting Started with OpenAPI 3.0 Pet Store
...
![Version Check](https://apidocs.io/illustration/typescript?workspaceFolder=OpenApi30PetStore&step=versionCheck)
...
![Resolve Dependencies](https://apidocs.io/illustration/typescript?workspaceFolder=OpenApi30PetStore&workspaceName=openapi-3-0-pet-storelib&step=resolveDependency)
...
- The created project manages its dependencies using its `package.json` file. In order to add a dependency on the *OpenAPI 3.0 Pet StoreLib* client library, double click on the `package.json` file in the bar on the left and add the dependency to the package in it.

![Add Openapi30PetStorelib Dependency](https://apidocs.io/illustration/typescript?workspaceFolder=OpenApi30PetStore&workspaceName=openapi-3-0-pet-storelib&step=importDependency)
...
![Install Openapi30PetStorelib Dependency](https://apidocs.io/illustration/typescript?step=installDependency)
...
```ts
import { Client, LogLevel } from 'openapi-3-0-pet-storelib';
...
import { Client } from 'openapi-3-0-pet-storelib';
